...
(function (a, b) {
    ...
    function C(a) {
        var b = this._data = {}, c = a.years || a.y || 0, d = a.months || a.M || 0, e = a.weeks || a.w || 0,
            f = a.days || a.d || 0, g = a.hours || a.h || 0, h = a.minutes || a.m || 0, i = a.seconds || a.s || 0,
    ...
    function H(b, d) {
        ...
        var e = b.month(), f = b.date(), g = b.year(), h = b.day(), i = b.hours(), j = b.minutes(), k = b.seconds(),
            m = b.milliseconds(), n = -b.zone(), o = c.ordinal, p = c.meridiem;
    ...
    function P(a, b) {
        var c = e(Math.abs(a) / 1e3), d = e(c / 60), f = e(d / 60), g = e(f / 24), h = e(g / 365),
    ...
    var c, d = "1.6.2", e = Math.round, f, g = {}, h = "en", i = typeof module != "undefined",
        ...
        m = /([0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)/gi, n = /\d\d?/, o = /\d{1,3}/, p = /\d{3}/,
        q = /\d{4}/, r = /[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/i, s = /Z|[\+\-]\d\d:?\d\d/i, t = /T/i,
    ...
    c = function (d, e) {
        ...
        clone: function () {
            ...
            var f = this._isUTC ? c(a).utc() : c(a).local(), g = (this.zone() - f.zone()) * 6e4, h = this._d - f._d - g,
                i = this.year() - f.year(), j = this.month() - f.month(), k = this.date() - f.date(), l;
            ...
            var a = this.diff(c().sod(), "days", !0), b = c.calendar, d = b.sameElse,
